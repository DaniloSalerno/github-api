...
<template>
  ...
  <div id="list">
    ...
    <div class="container">
      ...
      <!-- Se loader è true visuliazziamo il loader -->
      <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 g-3 py-5" v-if="this.state.loader">

        <AppLoader v-for="n in 20" />
      ...
      <div v-else-if="this.state.data.length > 0 && !this.state.loader" class="py-5">
        ...
        <div class="navigationBtns d-flex gap-5 align-items-md-center">
          ...
          <!-- <button @click="this.state.fetchData(this.state.urls.last)"
            v-if="this.state.urls.hasOwnProperty('last')">last</button> -->
          <!-- /Bottone last page, decommentare se serve -->
